...
import net.suntrans.ebuilding.fragment.EnvDetailFragment;
...
public class EnvDetailActivity2 extends BasedActivity {
    LinearLayout rootLL;
    TextView time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_env_detail2);
...
//        initView(info);
        ...
        tx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(EnvDetailActivity2.this, SensusConfigActivity.class);
...
//        initView(null);
        fragment = EnvDetailFragment.Companion.newInstance(id);
