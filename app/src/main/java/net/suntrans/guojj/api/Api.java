...
import net.suntrans.guojj.bean.Ammeter3Eneity;
import net.suntrans.guojj.bean.AreaDetailEntity;
import net.suntrans.guojj.bean.AreaEntity;
import net.suntrans.guojj.bean.ChangedPasswordEntity;
...
import net.suntrans.guojj.bean.SceneChannelResult;
import net.suntrans.guojj.bean.SceneEdit;
import net.suntrans.guojj.bean.SceneEntity;
import net.suntrans.guojj.bean.SceneTimeResult;
import net.suntrans.guojj.bean.SensusEntity;
import net.suntrans.guojj.bean.UpLoadImageMessage;
import net.suntrans.guojj.bean.UserInfo;
import net.suntrans.guojj.bean.YichangEntity;
