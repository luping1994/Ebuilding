...
import net.suntrans.guojj.activity.AboutActivity;
import net.suntrans.guojj.activity.ChangePassActivity;
import net.suntrans.guojj.activity.DeviceManagerActivity;
import net.suntrans.guojj.activity.LoginActivity;
import net.suntrans.guojj.activity.QuestionActivity;
import net.suntrans.guojj.activity.YichangActivity;
import net.suntrans.guojj.api.RetrofitHelper;
import net.suntrans.guojj.bean.SampleResult;
import net.suntrans.guojj.bean.UserInfo;
import net.suntrans.guojj.fragment.base.LazyLoadFragment;
import net.suntrans.guojj.fragment.din.ChangeNameDialogFragment;
import net.suntrans.guojj.fragment.din.UpLoadImageFragment;
                        ...
                        if (info != null) {
                            if (info.code == 200) {
                                ...
                                App.getSharedPreferences().edit().putString("user_id", info.data.id)
                                        ...
                                        .commit();
                                LogUtil.i("http://whgjjapp.suntrans-cloud.com" + info.data.avatar_url);
                                glideRequest
                                        .load("http://whgjjapp.suntrans-cloud.com" + info.data.avatar_url)
                                        .asBitmap()
