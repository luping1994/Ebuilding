...
import net.suntrans.guojj.activity.BasedActivity;
...
import static net.suntrans.guojj.BuildConfig.DEBUG;
...
public class MainActivity extends BasedActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!DEBUG)
            PgyUpdateManager.register(this, "net.suntrans.guojj.fileProvider");
        init();
    }
